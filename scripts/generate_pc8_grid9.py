...
OUTPUT_FILE = os.path.join(OUTPUT_DIR, "SeydaNeen_pc8_grid9.esp")
...
grid_refs = [r for r in refrs if (r["gx"], r["gy"]) == (-2, -9)][:8]
...
write_subrecord(buf, "CNAM", b"241STAT 8GRID9 1INT\x00")
