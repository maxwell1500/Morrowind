...
OUTPUT_FILE = r'C:\Users\max\Projects\Morrowind\Data\SeydaNeen_minimal_two_cells_v2.esp'
...
write_subrecord(buf, 'CNAM', b'Minimal Two Cells V2\x00')
...
# Exterior cells: one per subblock (type 5), one block (type 4), under WRLD children (type 1)
