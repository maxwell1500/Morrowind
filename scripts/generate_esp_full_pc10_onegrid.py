...
OUTPUT_FILE = os.path.join(OUTPUT_DIR, "SeydaNeen_pc10_onegrid.esp")
EXTERIOR_REFR_LIMIT = 10  # Set to int to limit exterior REFRs for testing
...
def main():
    ...
    for cell_name in cell_order:
        ...
        # REFR children -- skipped for isolation test
        persistent = io.BytesIO()
        # for refr in refrs_by_cell[cell_name]: ... SKIPPED
