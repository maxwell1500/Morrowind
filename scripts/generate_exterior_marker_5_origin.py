...
OUTPUT_FILE = os.path.join(OUTPUT_DIR, 'SeydaNeen_exterior_marker_5_origin.esp')
...
write_subrecord(buf, 'CNAM', b'Seyda Neen 5 Origin\x00')
...
# One exterior cell with 5 marker REFRs all at origin
grid_x, grid_y = -2, -10
cell_fid = alloc()
cell_sub = io.BytesIO()
