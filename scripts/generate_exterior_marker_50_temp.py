...
OUTPUT_FILE = os.path.join(OUTPUT_DIR, 'SeydaNeen_exterior_marker_50_temp.esp')
...
write_subrecord(buf, 'CNAM', b'Seyda Neen Exterior Marker 50 Temp\x00')
...
for grid_x, grid_y in exterior_grids:
    ...
    write_grup(persistent_grup, cell_fid, 9, persistent.getvalue())
