...
write_subrecord(buf, "CNAM", b"Seyda Neen Test Door Mesh\x00")
...
# Include the ex_nord_door_01 STAT from main ESP
# We'll extract it from main SeydaNeen.esp
...
# One REFR at origin pointing to ex_nord_door_01
...
open(r'C:\Users\max\Projects\Morrowind\Data\SeydaNeen_test_door_mesh.esp', 'wb').write(buf.getvalue())
print('Created test ESP with single REFR at origin using ex_nord_door_01 mesh')
