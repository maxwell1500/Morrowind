...
OUTPUT_FILE = os.path.join(OUTPUT_DIR, 'SeydaNeen_ministat_2_onegrid.esp')
...
# Exterior cell (-2,-10) with first 2 refs
grid_x, grid_y = -2, -10
grid_refs = [r for r in refrs if (r['gx'], r['gy']) == (grid_x, grid_y)][:2]
cell_fid = alloc()
cell_sub = io.BytesIO()
