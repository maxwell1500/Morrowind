...
OUTPUT_FILE = os.path.join(OUTPUT_DIR, "SeydaNeen_pc20_override.esp")
...
grid_refs = [r for r in refrs if (r["gx"], r["gy"]) == (-2, -10)][:20]
...
write_subrecord(buf, "CNAM", b"Override 20 REFR\x00")
