...
OUTPUT_FILE = os.path.join(OUTPUT_DIR, "SeydaNeen_pc50_persistent.esp")
...
write_subrecord(buf, "CNAM", b"Persistent 50 REFR\x00")
...
# Persistent cell with 50 REFRs (type 8)
...
print("50 REFRs in persistent cell (type 8), empty grid cell")
