...
OUTPUT_FILE = os.path.join(OUTPUT_DIR, "SeydaNeen_pc5_241stat.esp")
...
grid_refs = [r for r in refrs if (r["gx"], r["gy"]) == (-2, -10)][:5]
...
write_subrecord(buf, "CNAM", b"241STAT 5EXT 1INT\x00")
