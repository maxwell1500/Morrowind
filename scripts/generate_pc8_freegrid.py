...
OUTPUT_FILE = os.path.join(OUTPUT_DIR, "SeydaNeen_pc8_freegrid.esp")
...
grid_refs = [r for r in refrs if (r["gx"], r["gy"]) == (-2, -10)][:8]
...
write_subrecord(buf, "CNAM", b"241STAT 8FREEGRID\x00")
...
# Persistent cell at a free grid (use -100, -100)
...
write_subrecord(cell_sub, "XCLC", struct.pack("<iii", -100, -100, 0))
...
# Exterior cell at free grid (-2, -11) with 8 REFRs
grid_x, grid_y = -2, -11
...
print("8 REFRs in free grid (-2,-11), persistent at (-100,-100)")
