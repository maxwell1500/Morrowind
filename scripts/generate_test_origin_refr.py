...
write_subrecord(buf, "CNAM", b"Seyda Neen Test Single REFR\x00")
...
# One interior CELL (so CK has something to render)
...
# Exterior cell with one REFR at small local coords
...
open(r'C:\Users\max\Projects\Morrowind\Data\SeydaNeen_test_origin_refr.esp', 'wb').write(buf.getvalue())
print('Created test ESP with single REFR at (0,0,0)')
