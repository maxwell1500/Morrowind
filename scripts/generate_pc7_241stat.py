...
OUTPUT_FILE = os.path.join(OUTPUT_DIR, "SeydaNeen_pc7_241stat.esp")
...
grid_refs = [r for r in refrs if (r['gx'], r['gy']) == (-2, -10)][:7]
...
write_subrecord(buf, "CNAM", b"241STAT 7EXT 1INT\x00")
