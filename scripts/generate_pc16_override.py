...
OUTPUT_FILE = os.path.join(OUTPUT_DIR, "SeydaNeen_pc16_override.esp")
...
grid_refs = [r for r in refrs if (r['gx'], r['gy']) == (-2, -10)][:16]
...
write_subrecord(buf, "CNAM", b"Override 16 REFR\x00")
