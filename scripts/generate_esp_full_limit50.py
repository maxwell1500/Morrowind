...
OUTPUT_FILE = os.path.join(OUTPUT_DIR, "SeydaNeen_limit50.esp")
EXTERIOR_REFR_LIMIT = 50  # Set to int to limit exterior REFRs for testing
...
def main():
    ...
    write_subrecord(buf, "CNAM", b"Seyda Neen Limit50\\x00")
